...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝  ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://telegram.me/allmovises00")]]), disable_web_page_preview=True
    )
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⛔️  Join Our Official Channel  ​ ⛔️", url="https://telegram.me/rudraraut")
    ])
    try:
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                          InlineKeyboardButton("❤️‍🔥 ᴄʜᴀɴɴᴇʟ​ ❤️‍🔥", url="https://telegram.me/Rudraraut")
                             ]
                            ]
                        )
                    )
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton("❤️‍🔥 ᴄʜᴀɴɴᴇʟ​ ❤️‍🔥", url="https://telegram.dog/Rudraraut")
                 ]
                ]
            )
        )
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://telegram.me/allmovises00")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ʏᴛ  ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/"),
        ],[
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url="https://telegram.me/allmovises00"),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url="https://telegram.me/Rudraraut")
        ],[
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url="https://telegram.me/allmovises00"),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url="https://telegram.me/+BVPpCkfu8uthZTc1")
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ​', callback_data='start')
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Join Our Official Channel', url='https://telegram.me/rudraraut')
        ],[
            InlineKeyboardButton('ʀᴇᴘᴏʀᴛ  ʙᴜɢꜱ  ᴀɴᴅ  ꜰᴇᴇᴅʙᴀᴄᴋ', url='https://t.me/routbotowner_bot')
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
        ...
        buttons = [[
                    InlineKeyboardButton("💶    ᴘʟᴇᴀsᴇ  ᴅᴏɴᴀᴛᴇ    💶", url="https://te.legra.ph/file/fcdd180561bf72c016dea.jpg")
                 ],[
                    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="start"),
        ...
        await query.message.edit_text(
            ...
            btn = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ʜᴇʟᴘ', url='https://telegram.me/routbotowner_bot')
            ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
